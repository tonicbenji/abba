...
// The generators each collate a large object of data for each page. This data is is contextually specific to the page being generated. They then pass this object to a function that turns it into a series of regular expressions. These regexes are then applied to the particular template of this page type. They replace moustache tokens in the template files, which are denoted like this: {{token}}. After this, the output is written to the 'public' folder as a finished page.
...
// src/ - templates. This contains some unused files and data that are leftovers from before.
