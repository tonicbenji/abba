    ...
    return {
        ...
        keywordLists: {
            industry: [
                ...
                `${buySell}ing a ${industry} Business`,
                `${buySell}ing a ${industry} Centre`,
                `${buySell} Preschool Business`,
...
const city = ({ city, buySell }) => {
    return {
        ...
        description: U.description(
            buySell === "Buy"
                ? "When buying an independent centre in Sydney, you have more freedom and potentially higher profit margins, whereas with a franchise you have more guidance and potentially lower risk."
                : "As you are probably well aware, Sydney does have an oversupply of childcare businesses. This oversupply is worse in some areas than others."
        )
    };
};
